...
class PoseDisplay : public gz::gui::Plugin
{
  Q_OBJECT
  ...
  /// \brief Destructor
  public: ~PoseDisplay() override;

  // Documentation inherited
  public: void LoadConfig(const tinyxml2::XMLElement *_pluginElem) override;

  /// \brief Get the topic.
  /// \return Topic, the pose topic.
  public: Q_INVOKABLE QString Topic() const;

  /// \brief Set the topic.
  /// \param[in] _topic The pose topic.
  ...
  /// \brief Filter size sets the number of poses kept.
  ...
  /// this number, older poses are removed.
  ...
  private: std::unique_ptr<PoseDisplayPrivate> dataPtr;
};
